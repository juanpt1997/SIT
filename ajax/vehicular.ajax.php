...
class AjaxVehiculos
{
    ...
    static public function ajaxTablaConductores($idvehiculo)
    {
        ...
        foreach ($Respuesta as $key => $value) {
            ...
            $btnConsultar = "<a target='_blank' href='https://fcm.org.co/simit/#/estado-cuenta?numDocPlacaProp={$value['Documento']}'><button type='button' class='btn btn-sm bg-warning m-1' title='Consultar infracciones' documento='{$value['Documento']}'><i class='fas fa-search '></i></button></a>";
