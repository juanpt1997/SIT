...
require_once '../controllers/mv.controlador.php';
require_once '../models/mv.modelo.php';
...
class AjaxVehiculo
{
    ...
    ===================================================*/
    static public function ajaxGuardarvehiculo($formData, $foto)
    {
    ...
    ===================================================*/
    static public function ajaxshowvehiculo($idvehiculo)
    {
        $respuesta = ControladorMV::ctrDatosVehiculo($idvehiculo);
    ...
    ===================================================*/
    // static public function ajaxCambiardocumentos($idPersonal, $estadoActual)
    // {
    ...
    // ===================================================*/
    // static public function ajaxGuardocumentos($formData)
    // {
    ...
    //     TABLA HIJOS
    // ===================================================*/
    // static public function ajax($idPersonal)
    // {
    ...
    //    ELIMINAR HIJO
    // ===================================================*/
    // static public function ajaxEliminarvhiculo($idhijo)
    // {
    //     $datos = array(
    ...
    // ===================================================*/
    // static public function ajaxGuarrutaimagenes($formData)
    // {
    ...
    // ===================================================*/
    // static public function ajaxverimaenes($idPersonal)
    // {
...
if (isset($_POST['DatosVehiculo']) && $_POST['DatosVehiculo'] == "ok") {
    AjaxPersonal::ajaxshowvehiculo($_POST['idvehiculo']);
}


if (isset($_POST['GuardarPersonal']) && $_POST['GuardarPersonal'] == "ok") {
    $foto = isset($_FILES['foto']) ? $_FILES['foto'] : "";
    AjaxPersonal::ajaxshowvehiculo($idvehiculo);
}
