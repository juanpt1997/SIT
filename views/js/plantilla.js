...
$(document).on("click", ".btn-FTConductor", function () {
    ...
    window.open(
        `./pdf/pdfconductor.php?idPersonal=${idPersonal}`,
        "",
...
/*============================================
        FUNCIÓN SEMAFORO TIPO 1
    ==============================================*/
const semaforo_tipo1 = (fecha, fecha_limite) => {
    var fecha1 = moment(fecha);
    var fecha2 = moment(fecha_limite);

    if (fecha1.diff(fecha2, "days") >= 31) {
        bg = "success";
    } else if (
        fecha1.diff(fecha2, "days") >= 0 &&
        fecha1.diff(fecha2, "days") <= 30
    ) {
        bg = "warning";
    } else {
        bg = "danger";
...
const semaforo_tipo2 = (fecha, fecha_limite) => {
    var fecha1 = moment(fecha);
    var fecha2 = moment(fecha_limite);
