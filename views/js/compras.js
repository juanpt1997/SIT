$(document).ready(function () {
    ...
    if (
        ...
        $(".btn_editar").on("click", function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#tipoProveedor").val(response.id_tipo_proveedor);
        ...
        // $(document).on("shown.bs.modal", "#modal-nuevo", function () {
        //     cargarSelectTipoProveedor();
        // });

        // const cargarSelectTipoProveedor = () => {
        //     let datos = new FormData();
        //     datos.append("cargarSelectTipoPro", "ok");
        //     $.ajax({
        //         type: "POST",
