<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="brand-link">
        <img src="<?= URL_APP ?>views/img/plantilla/isotipoTL.jpg" alt="" class="brand-image img-circle elevation-3"
            style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <a href="<?= URL_APP ?>inicio">
            <div class="image text-center mt-4">
                <img src="<?= URL_APP ?>views/img/plantilla/logo.png" class="img-fluid img-circle elevation-2 w-50"
                    alt="User Image">
            </div>
        </a>
        ...
        <!-- Sidebar Menu -->
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-compact text-sm nav-child-indent"
