...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark "><strong><i>Consulta comparendos y acuerdos de pago </i> <i class="fas fa-traffic-light"></i></strong></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="inicio">Inicio</a></li>
                        <li class="breadcrumb-item active">Consulta comparendos y acuerdos de pago</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 ">
                    <div class="dropdown col-lg-12 col-md-6 col-sm-3" style="cursor: pointer;">
                        <div class="info-box border border-danger" id="ConsultasGenerales" data-toggle="dropdown">
                            ...
                            <div class="info-box-content text-break">
                                <span class="info-box-text font-weight-bold text-dark ">
