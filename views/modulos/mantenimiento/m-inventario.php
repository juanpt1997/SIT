                                        ...
                                        <table id="tabla_resumen_inventario" class="table table-sm table-bordered table-striped text-center nowrap">
                                            ...
                                            <tbody>
                                                <?php foreach ($ListaInventario as $key => $value) : ?>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <button type="button" title="PDF inventario" data-toggle="tooltip" data-placement="top" class="btn btn-secondary btn-sm btn-verInventario" id_inventario="<?= $value['id'] ?>"><i class="fas fa-file-pdf"></i></button>
