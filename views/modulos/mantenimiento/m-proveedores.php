                            ...
                            <div class="col-sm-12">
                                <div class="row mb">
                                    <div class="col-sm text-center">
                                        <button type="button" class="btn bg-gradient-warning" data-toggle="modal" data-target="#modal-nuevo"><i class="far fa-file"></i> Nuevo</button>
                                ...
                                <table id="example1" class="table table-bordered table-striped text-center tablas">
                                    <thead>
                                        <tr>
                                            <th>...</th>
                                            <th>ID</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal-imprimir"><i class="fas fa-print"></i></button>
