...
<style>
    .parallax1 {
        ...
        background-image: url("<?= URL_APP ?>views/img/plantilla/inicio3.jpg");
        min-height: 500px;
        min-width: 500px;
    ...
    .parallax2 {
        ...
        background-image: url("<?= URL_APP ?>views/img/plantilla/inicio4.jpg");
        min-height: 500px;
        min-width: 500px;
        background-attachment: fixed;
        background-position: center;
    ...
    .parallax3 {
        ...
        background-image: url("<?= URL_APP ?>views/img/plantilla/inicio5.jpg");
        min-height: 500px;
        min-width: 500px;
        background-attachment: fixed;
        background-position: center;
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mt-2 mb-2">
                <div class="col-sm-6">
                    <h1><b><i>Tablero de módulos</i></b></h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div><!-- /.content-header -->
