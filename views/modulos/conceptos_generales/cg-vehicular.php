                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6 col-md-6 text-nowrap">
                                    <div class="info-box border border-secondary">
                                        ...
                                        <!-- /.info-box-content -->
                                        <div class="d-flex flex-column">
                                            <button concepto="Tipos de vehiculos" type="button" class="btn-toolbar btn-ver-tipos btn-sm btn-info float-right" style="margin: 1px;" data-toggle="modal" data-target="#VisualizarV1"><i class="far fa-eye"></i></button>
                                            <button concepto="Tipos de vehiculos" type="button" class="btn-toolbar btn-nuevo-tipo btn-sm btn-success float-right" style="margin: 1px;" data-toggle="modal" data-target="#AgregarTipoVel"><i class="fas fa-plus-circle"></i></button>
                                        </div>
...
<!-- =================================================================
     ========MODALS CREAR / EDITAR 3======================================
     ==================================================================-->
<div class="modal fade" id="AgregarTipoVel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title" id="titulo_tipo_vehi"></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" enctype="multipart/form-data" id="formulario_tipo_vehiculo">
                <div class="modal-body">
                    <input type="hidden" id="idGH" name="idGH" value="">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select class="custom-select rounded-0" id="input_categoria" name="input_categoria" required>
                                <option value="" selected>Seleccione una categoría</option>
                                <option value="BUS-BUSETA">BUS-BUSETA</option>
                                <option value="CAMIONETA-MICRO">CAMIONETA-MICRO</option>
                            </select>
                        </div>
                    </div>
                </div>
