            ...
            <div class="row">
                <div class="col">
                    <div class="card border border-secondary">
                        <div class="card-header bg-success"><h5>Agregar / Ver registros / Editar / Eliminar</h5></div>
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="info-box border border-secondary">
                                      <span class="info-box-icon bg-primary elevation-1"><i class="fas fa-file-signature"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text">Objeto de contrato</span>
                                        ...
                                        <!-- /.info-box-content -->
                                            <div>
                                                <button type="button" class="btn-toolbar btn-sm btn-info float-right" style="margin: 1px;"><i class="far fa-eye"></i></button>
                                                <button type="button" class="btn-toolbar btn-sm btn-success float-right" style="margin: 1px;"><i class="fas fa-plus-circle"></i></button>  
                                            </div>
                                    </div>
                                    <!-- /.info-box -->
                                </div>
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <div class="info-box border border-secondary">
                                      <span class="info-box-icon bg-info elevation-1"><i class="fas fa-road"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text">Rutas y recorridos</span>
                                            <span class="info-box-number">
                                                    10
                                                <small>registros</small>
                                            </span>        
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <div class="info-box border border-secondary">
                                      <span class="info-box-icon bg-success elevation-1"><i class="fas fa-dollar-sign"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text">Recorridos y precios</span>
                                            <span class="info-box-number">
                                                    10
                                                <small>registros</small>
                                            </span>        
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <div class="info-box border border-secondary">
                                      <span class="info-box-icon bg-primary elevation-1"><i class="fas fa-id-badge"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text">Categorias de licencias</span>
                                            <span class="info-box-number">
                                                    10
                                                <small>registros</small>
                                            </span>        
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <div class="info-box border border-secondary">
                                      <span class="info-box-icon bg-success elevation-1"><i class="fas fa-registered"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text">Marcas de vehículos</span>
                                            <span class="info-box-number">
                                                    10
                                                <small>registros</small>
                                            </span>        
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <div class="info-box border border-secondary">
                                      <span class="info-box-icon bg-dark elevation-1"><i class="fas fa-file-alt"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text">Documento vehicular</span>
                                            <span class="info-box-number">
                                                    10
                                                <small>registros</small>
                                            </span>        
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <div class="info-box border border-secondary">
                                      <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-bus-alt"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text">Tipos de vehículos</span>
                                            <span class="info-box-number">
                                                    10
                                                <small>registros</small>
                                            </span>        
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <div class="info-box border border-secondary">
                                      <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-id-card-alt"></i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text">Tipos de identificación</span>
                                            <span class="info-box-number">
                                                    10
                                                <small>registros</small>
                                            </span>        
