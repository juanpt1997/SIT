                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <div class="info-box border border-secondary">
                                      <span class="info-box-icon bg-info elevation-1"><i class="fas fa-road"></i></span>
                                        ...
                                        <!-- /.info-box-content -->
                                            <div>
                                                <button concepto="Rutas y recorridos" type="button" class="btn-toolbar btn-ver btn-sm btn-info float-right" style="margin: 1px;" data-toggle="modal" data-target="#VisualizarV"><i class="far fa-eye"></i></button>
                                                <button concepto="Rutas y recorridos" type="button" class="btn-toolbar btn-nuevo btn-sm btn-success float-right" style="margin: 1px;" data-toggle="modal" data-target="#AgregarEditarV" id="btn-tausentismo"><i class="fas fa-plus-circle"></i></button>  
                                            </div>
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <div class="info-box border border-secondary">
                                      <span class="info-box-icon bg-primary elevation-1"><i class="fas fa-id-badge"></i></span>
                                        ...
                                        <!-- /.info-box-content -->
                                            <div>
                                                <button concepto="Categorias de licencias" type="button" class="btn-toolbar btn-ver btn-sm btn-info float-right" style="margin: 1px;" data-toggle="modal" data-target="#VisualizarV"><i class="far fa-eye"></i></button>
                                                <button concepto="Categorias de licencias" type="button" class="btn-toolbar btn-nuevo btn-sm btn-success float-right" style="margin: 1px;" data-toggle="modal" data-target="#AgregarEditarV" id="btn-tausentismo"><i class="fas fa-plus-circle"></i></button>  
                                            </div>
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <div class="info-box border border-secondary">
                                      <span class="info-box-icon bg-dark elevation-1"><i class="fas fa-file-alt"></i></span>
                                        ...
                                        <!-- /.info-box-content -->
                                            <div>
                                                <button concepto="Documento vehicular" type="button" class="btn-toolbar btn-ver btn-sm btn-info float-right" style="margin: 1px;" data-toggle="modal" data-target="#VisualizarV"><i class="far fa-eye"></i></button>
                                                <button concepto="Documento vehicular" type="button" class="btn-toolbar btn-nuevo btn-sm btn-success float-right" style="margin: 1px;" data-toggle="modal" data-target="#AgregarEditarV" id="btn-tausentismo"><i class="fas fa-plus-circle"></i></button>  
                                            </div>
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <div class="info-box border border-secondary">
                                      <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-id-card-alt"></i></span>
                                        ...
                                        <!-- /.info-box-content -->
                                            <div>
                                                <button concepto="Tipos de identificación" type="button" class="btn-toolbar btn-ver btn-sm btn-info float-right" style="margin: 1px;" data-toggle="modal" data-target="#VisualizarV"><i class="far fa-eye"></i></button>
                                                <button concepto="Tipos de identificación" type="button" class="btn-toolbar btn-nuevo btn-sm btn-success float-right" style="margin: 1px;" data-toggle="modal" data-target="#AgregarEditarV" id="btn-tausentismo"><i class="fas fa-plus-circle"></i></button>  
                                            </div>
