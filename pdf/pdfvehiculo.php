...
class PdfVehiculo
{
    ...
    static public function makePDF($info)
    {
        ...
        foreach ($Documentos as $key => $documento) {
            //var_dump($documento['tipodocumento']);
            switch ($documento['tipodocumento']) {
                ...
                case 'Revisión tecnico-mecánica':
                    $CDA = $documento;
        ...
        <table cellspacing="2" cellpadding="3">
            <tbody>
                <tr style="text-align: center; font-weight:bold;">
                    <th colspan="2" border="1" width="625"><i>MATRÍCULA</i></th>
                </tr>
        ...
        <table cellspacing="2" cellpadding="3">
               <tbody>
                    <tr style="text-align: center; font-weight:bold;">
                        <td border="1"><i>SOAT</i></td>
                        <td border="1"><i>REVISIÓN TECNO-MECÁNICA Y DE GASES</i></td>
                    </tr>
        ...
        // This method has several options, check the source code documentation for more information.
        $pdf->Output('FTVehiculo-'. $info['placa'], 'I');
