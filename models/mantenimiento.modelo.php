    ...
    static public function mdlAgregarRevision($datos)
        {
            ...
            //      $stmt->bindParam(":relog_vigia",$datos['relog_vigia'],PDO::PARAM_INT);     
            ...
            //      $stmt->bindParam(":señales_carretera",$datos['señales_carretera'],PDO::PARAM_INT);     
            //      $stmt->bindParam(":botiquin",$datos['botiquin'],PDO::PARAM_INT);     
            //      $stmt->bindParam(":extintor",$datos['extintor'],PDO::PARAM_INT);     
            ...
            //      $stmt->bindParam(":observacion",$datos['observacion'],PDO::PARAM_INT);     
