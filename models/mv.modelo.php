...
class ModeloMV
{
    ...
    {   
     ...
     /* ===================================================
          SHOW  VEHICULOS
    ===================================================*/
    static public function mdlVehiculoshow($idvehiculo)
    {   
        #el vehiculo selecionado
         
            $sql = "SELECT * FROM modulovehiculos WHERE idvehiculo=?" ;
   
            $stmt = Conexion::conectar()->prepare($sql);
            $stmt->execute(array($idvehiculo));
            $retorno =  $stmt->fetch();
    ...
    ===================================================*/
    // static public function mdlDelete()
    // {
