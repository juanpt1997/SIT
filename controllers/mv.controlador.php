...
class ControladorMV
{
    ...
    /* ===================================================
            LISTADO PERSONAL
        ===================================================*/
    static public function ctrListaMV()
    {
        $respuesta = ModeloMV::mdlVehiculo(null);
        return $respuesta;
    }
      /* ===================================================
       DATOS DEL VEHICULO
    ===================================================*/
    static public function ctrDatosVehiculo($idvehiculo)
    {
        $vehiculo = ModeloMV::mdlDatosEmpleado($idvehiculo);
        return $vehiculo;
    }
 ...
 //    ===================================================*/
 //    static public function ctrMostrarvehiculo($idvehiculo)
 //    {
 //        $respuesta = ModeloGH::mdlMostrarHijos($idvehiculo);
 //        return $respuesta;
 //    }
